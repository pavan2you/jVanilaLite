 ...
 *
 */
public class VanilaBindableViewHolder<T> implements IBindableView<T> {
    ...
    public VanilaBindableViewHolder(View binderTaggedView) {
        mView = binderTaggedView;
        mBinderClass = (String) binderTaggedView.getTag(TAG_ID_4_BINDER);
        onCreate();
    }

    public VanilaBindableViewHolder(View view, String binderClass) {
        mView = view;
        mBinderClass = binderClass;
        onCreate();
    }

    public VanilaBindableViewHolder(Context context, int layoutResId, ViewGroup parent,
            boolean attachToRoot, String binderClass) {

        LayoutInflater inflater = LayoutInflater.from(context);
        mView = inflater.inflate(layoutResId, parent, attachToRoot);
        mBinderClass = binderClass;
        onCreate();
    }

    public VanilaBindableViewHolder(ViewStub viewStub, String binderClass) {
        mView = viewStub.inflate();
        mBinderClass = binderClass;
        onCreate();
    }

    public VanilaBindableViewHolder(ViewStub viewStub, int layoutResId, String binderClass) {
    ...
    public void addTag(T tag) {
        mTag = tag;
        mView.setTag(this);//Important line
